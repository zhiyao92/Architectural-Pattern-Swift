...
SWIFT_CLASS("_TtC3MVC20DetailViewController")
...
SWIFT_CLASS("_TtC3MVC17HomeTableViewCell")
...
SWIFT_CLASS("_TtC3MVC18HomeViewController")
...
@interface HomeViewController (SWIFT_EXTENSION(MVC)) <UITableViewDelegate>
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
@end


@interface HomeViewController (SWIFT_EXTENSION(MVC)) <UITableViewDataSource>
