...
#ifndef CLEAN_ARCHITECTURE_SWIFT_H
#define CLEAN_ARCHITECTURE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Clean_Architecture",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC18Clean_Architecture11AppDelegate")
...
SWIFT_CLASS("_TtC18Clean_Architecture20DetailViewController")
@interface DetailViewController : UIViewController
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)viewDidLoad;
- (IBAction)tapCompleteButton;
- (IBAction)tapGiveUpButton;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil SWIFT_UNAVAILABLE;
@end


SWIFT_CLASS("_TtC18Clean_Architecture17HomeTableViewCell")
...
SWIFT_CLASS("_TtC18Clean_Architecture18HomeViewController")
...
@interface HomeViewController (SWIFT_EXTENSION(Clean_Architecture)) <UITableViewDelegate>
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
@end


@interface HomeViewController (SWIFT_EXTENSION(Clean_Architecture)) <UITableViewDataSource>
...
SWIFT_CLASS("_TtC18Clean_Architecture13SceneDelegate")
