...
SWIFT_CLASS("_TtC4MVVM11AppDelegate")
...
SWIFT_CLASS("_TtC4MVVM20DetailViewController")
...
SWIFT_CLASS("_TtC4MVVM17HomeTableViewCell")
...
SWIFT_CLASS("_TtC4MVVM18HomeViewController")
...
@interface HomeViewController (SWIFT_EXTENSION(MVVM)) <UITableViewDelegate>
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
@end


@interface HomeViewController (SWIFT_EXTENSION(MVVM)) <UITableViewDataSource>
...
SWIFT_CLASS("_TtC4MVVM13HomeViewModel")
...
SWIFT_CLASS("_TtC4MVVM13SceneDelegate")
