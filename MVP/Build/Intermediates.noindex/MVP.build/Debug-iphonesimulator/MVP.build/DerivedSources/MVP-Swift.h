...
SWIFT_CLASS("_TtC3MVP20DetailViewController")
...
SWIFT_CLASS("_TtC3MVP17HomeTableViewCell")
...
SWIFT_CLASS("_TtC3MVP18HomeViewController")
...
@interface HomeViewController (SWIFT_EXTENSION(MVP)) <UITableViewDelegate>
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
@end


@interface HomeViewController (SWIFT_EXTENSION(MVP)) <UITableViewDataSource>
...
SWIFT_CLASS("_TtC3MVP13SceneDelegate")
